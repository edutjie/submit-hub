    ...
    <Drawer>
      ...
      <DrawerContent className="bg-white">
        <div className="mx-auto w-full max-w-sm">
          <DrawerHeader>
            <DrawerTitle className="text-h3 font-semibold text-black">Upload Files</DrawerTitle>
            <DrawerDescription className="text-md font-semibold text-medium-gray">
          ...
          <div className="p-4 pb-0">
            <div className="flex flex-col items-center justify-center p-[40px] border-2 border-dashed border-light-gray rounded-[20px] bg-off-white text-medium-gray text-center space-y-4 transition-colors hover:bg-[#F2F3F5]">
              ...
              <p className="text-md font-medium">Click or drag files here to upload</p>
            </div>
          </div>
          <DrawerFooter>
